...
export default {
    ...
    server: [
        ...
        { path: '/worlds', permission: 'file.read', name: vt('Mondes'), component: ServerTools, exact: true },
        { path: '/version', permission: 'startup.read', name: 'Version', component: ServerTools, exact: true },
