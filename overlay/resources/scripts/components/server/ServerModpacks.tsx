...
interface Plan { companion: CompanionOffer; token: string; title: string; release: string; minecraft: string; software: string; loader: string | null; java: number; size: number; files: number; optional: string[]; skipped: number; }
