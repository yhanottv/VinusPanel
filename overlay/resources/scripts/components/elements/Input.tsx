...
const light = css<Props>`
    ${tw`border-neutral-600 bg-neutral-900 text-neutral-100`};
    &:focus {
        ${tw`border-primary-400`}
    }

    &:disabled {
        ${tw`border-neutral-700 bg-neutral-800`};
    }
`;
...
const inputStyle = css<Props>`
    ...
    ${tw`rounded-lg border p-3 text-sm transition-all duration-150`};
    ...
    &:not(:disabled):not(:read-only):focus {
        ${tw`border-primary-400 shadow-md ring-2 ring-primary-400 ring-opacity-20`};
