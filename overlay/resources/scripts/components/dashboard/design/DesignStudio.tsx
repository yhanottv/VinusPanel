    ...
    return <div className={styles.studio}>
        ...
        <aside className={styles.controls}>
            ...
            <div className={styles.controlsBody}>
                ...
                {category==='motion'&&!query&&<><p className={styles.hint}>Survolez ou sélectionnez une vignette pour voir l’effet. Le réglage de réduction des animations de votre appareil est respecté.</p><button type="button" className={styles.secondaryButton} onClick={()=>{setPreviewTick(t=>t+1);window.dispatchEvent(new Event('vinus:preview-replay'));}}>Rejouer l’animation de la page</button></>}
