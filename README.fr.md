...
| Réglage | Rôle |
| --- | --- |
| `VINUS.name` | Nom défini par le menu Design et utilisé dans les composants. |
| `VINUS.logo` | Logo défini par le menu Design ; ne régénère pas la signature Unicode du terminal. |
