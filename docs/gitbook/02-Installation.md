...
Résultat attendu : huit lignes `active`, une réponse `HTTP/1.1 200` ou `302`, Pterodactyl `1.15.1`, la version du thème (`3.2.0`), celle du catalogue (`1.4.2`) et environ 40 routes `vinuscatalog`.
